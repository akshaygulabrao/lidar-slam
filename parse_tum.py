...
def convert_to_tum(input_file, output_file):
    ...
    tum_df.to_csv(output_file, sep=' ', header=False, index=False, float_format='%.9f')

input_filename = '/Users/ox/workspace/newer-college-1/collection1-newer-college/ground_truth/gt-nc-quad-easy.csv'
output_filename = 'proper_tum_format.tum'
convert_to_tum(input_filename, output_filename)